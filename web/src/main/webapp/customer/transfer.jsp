...
<head>
    ...
    <title>Fund Transfer - National Bank</title>
    <style>
        ...
        input[type="text"], input[type="number"], select { width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 4px; box-sizing: border-box; }
...
<div class="container">
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/customer/transfer" method="post">
            ...
            <button type="submit" class="btn">Proceed to Verify</button>
        </form>
    </div>
</div>
</body>
